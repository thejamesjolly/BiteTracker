...
windowIndex = numpy.zeros(shape=(MAX_WINDOWS, 1))
windowBites = numpy.zeros(shape=(MAX_WINDOWS, 1))
floatWindowBites = numpy.zeros(shape=(MAX_WINDOWS, 1))
...
GTbiteIndex = numpy.zeros(shape=(MAX_BITES, 1))
